...
public interface DailyCustomerStockPortfolioPersianMapper extends SelmaObjectMapper<List<CustomerStockPortfolioTadbir>, List<DailyCustomerStockPortfolio>> {
}
